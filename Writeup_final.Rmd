...
In this time data science project, the issue we are discussing is the distance between asteroids and the Earth. We want to do the calculation in two different ways. The first main variable is use the Semi major axis, and for the second main variable is the orbital period. These are the two main variables we choose from our dataset.
