...
- Method 1: Using ggplot to create two histograms with x-axis is "a" (semi-major axis) and x-axis is "per_y" (orbital period) correspondingly.
...
Creating a linear model between `a` and 
